...
const AuthFlow = () => {
  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`https://ridewise-server.vercel.app/api/auth/user/${authData.email}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://ridewise-server.vercel.app/api/auth/signup', {
        ...formData,
        userType,
      });
      setRegistrationComplete(true);
