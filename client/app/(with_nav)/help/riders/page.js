...
const Riders = () => {
  ...
  const helpTopics = [
    ...
    {
      title: "Feedback about the driver or vehicle",
      description: "Share feedback about your driver or vehicle.",
    },
    {
      title: "Safety",
      description: "Access safety resources and report safety-related issues.",
    },
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 mt-24">
      <h1 className="text-3xl font-bold mb-6">
        Support Resources for RideWise Riders
      </h1>
