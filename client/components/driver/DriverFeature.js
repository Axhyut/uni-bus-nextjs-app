  ...
  const features = [
    {
      ...
      description:
        "Set your own pickup and drop-off locations that suit your daily commute",
    ...
    },
    {
      ...
      description:
        "Choose your availability and manage your schedule with ease",
    ...
    },
    {
      ...
      description:
        "View and accept ride requests in advance for better planning",
          ...
          {features.map((feature, index) => (
            <div key={index} className="relative group">
              ...
              <div className="relative bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-full border border-gray-600">
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-r ${feature.color} p-3 mb-8 text-white transform group-hover:scale-110 transition-transform duration-300`}
                >
                  {feature.icon}
                </div>
